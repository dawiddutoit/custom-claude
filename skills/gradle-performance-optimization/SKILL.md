...
description: |
  Optimize Gradle build performance using caching, configuration cache, parallel execution,
  and memory tuning. Use when builds are slow, in CI/CD pipelines, or for large multi-module
  projects. Achieve 50-80% faster builds with proper configuration.
---
