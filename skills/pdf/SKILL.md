...
name: pdf
description: |
  Comprehensive PDF manipulation using pypdf, pdfplumber, and ReportLab for text extraction,
  table parsing, document creation, merging/splitting, and form filling. Use when asked to
  "extract text from PDF", "fill PDF form", "merge PDFs", "create a PDF document", "split PDF
